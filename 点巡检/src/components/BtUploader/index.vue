      ...
      <div class="innerList">
        <ul class="bt-uploaded-filelist">
          <li v-for="file in uploadedFileList" :key="file.id">
            ...
            <div class="bt-uploaded-meta" />
            <div class="bt-uploaded-status" />
            <div class="bt-uploaded-actions">
              ...
              <a
                ...
                target="_blank"
              />
              <span class="uploaded-file-del" @click="del(file)" />
            </div>
          </li>
        </ul>
        <uploader-list>
