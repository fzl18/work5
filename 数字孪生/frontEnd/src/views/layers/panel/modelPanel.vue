<template>
  <div class="modelPanel" :style="calcStyle">
    <!-- <div class="button" v-if="!$store.state.panel.modelPlanVisible">
      <div class="" @click="handleSkip">跳过</div>
    </div> -->
    <div class="button" v-if="$store.state.index.curObjLevel == 4">
      <div class="" @click="handleUe('AutoRotButton')">
      ...
      <!-- <div class="" @click="handleLabel">广告牌</div> -->
      ...
      <div class="" @click="handleUe('ReturnButton')">
        <svg class="icon" aria-hidden="true">
...
import webrtc from "../../../common/videoPlayer/app";
import {
