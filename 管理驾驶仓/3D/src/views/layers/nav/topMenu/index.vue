...
<script>
import Params from "@/views/components/params";
import Popup from "@/views/components/popup";
import { lineInfo } from "@/views/api/monitorLine";
import { addOrUpdate } from "@/views/api/charts";
...
export default {
  ...
  computed: {
    small() {
      let style = {};
      if (this.$store.state.index.isFullscreen) {
        style = {
  ...
  methods: {
    ...
    rest() {
      ...
      this.$store.state.index.rightChartsItem = [
        "chart5",
        "chart6",
        "chart7",
        "chart10",
...
.topMenu {
  ...
  .top {
    ...
    &::after {
      ...
      animation: lineShine 7s cubic-bezier(1, 1, 1, 1) infinite;
    }
    .logo {
      transform: scale(0.9);
      position: relative;
      ...
      .left {
        ...
        .sort {
          ...
          .item {
            ...
            &.chart1 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart1.jpg")
                no-repeat;
            }
            &.chart2 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart2.jpg")
                no-repeat;
            }
            &.chart3 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart3.jpg")
                no-repeat;
            }
            &.chart4 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart4.jpg")
                no-repeat;
            }
            &.chart5 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart5.jpg")
                no-repeat;
            }
            &.chart6 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart6.jpg")
                no-repeat;
            }
            &.chart7 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart7.jpg")
                no-repeat;
            }
            &.chart8 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart8.jpg")
                no-repeat;
            }
            &.chart9 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart9.jpg")
                no-repeat;
            }
            &.chart10 {
              background: #000
                url("../../../../assets/img/skin/blackgold/chart10.jpg")
                no-repeat;
            }
          }
        }
    ...
    .left {
      ...
      .sort {
        ...
        .item {
          ...
          &.chart8 {
            background: #000
              url("../../../../assets/img/skin/blackgold/chart8.jpg") no-repeat;
          }
          &.chart9 {
            background: #000
              url("../../../../assets/img/skin/blackgold/chart9.jpg") no-repeat;
          }
          &.chart10 {
            background: #000
              url("../../../../assets/img/skin/blackgold/chart10.jpg") no-repeat;
          }
        }
      }
    }
