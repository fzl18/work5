<template>
  <span v-if="showTheme">
    <!-- <remix-icon icon-class="brush-2-line" @click="handleOpenTheme"></remix-icon> -->
    <!-- <div class="theme-setting">
      <div @click="handleOpenTheme">
        <remix-icon icon-class="brush-2-line"></remix-icon>
        <p>{{ translateTitle('主题配置') }}</p>
      </div>
      <div @click="randomTheme">
        <remix-icon icon-class="apps-line"></remix-icon>
  ...
  export default {
    ...
    methods: {
      ...
      ...mapActions({
        ...
        handleShowTabsBar: 'settings/handleShowTabsBar',
