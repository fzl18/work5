        ...
        <div class="box">
          <div class="head">
            <div class="title">
              {{ tit }}
              <br />
              <div v-if="type == 'import'" class="num">
                编号: {{ form.number || '自动生成' }}
              </div>
          ...
          <div>
            <div class="">
              <span v-if="type != 'import'">供应商：{{ form.company }}</span>
              <el-form-item
                v-if="type == 'import'"
                label="供应商"
                prop="company"
          ...
          <!--      申请单    -->
          <div v-if="type == 'import'" class="body">
...
<script>
  ...
  import { importEdit, buscusIndex } from './api'
    ...
    methods: {
      ...
      showEdit(row) {
        ...
        if (!row) {
          ...
          this.title = this.type == 'import' ? '编辑' : '开具'
          // if (row.deliv) {
